...
text-align: left;">
  ...
  margin-bottom: 10px;
  text-align: left;">
    <p><em>Vidéo d'introduction par <b>Sebastien et Loïc</b>: <a href="https://youtu.be/********" rel="nofollow noopener noreferrer"
  ...
  <div class="statement-section statement-rules">
    ...
    <div class="statement-rules-content">
      ...
      <p>Chaque équipe commence la partie avec 4 cartes compétence <strong>généraliste</strong> et 4 cartes compétence <strong>Dette Technique</strong> Ces cartes seront sa pioche personnelle et sa défausse sera recyclée pour refaire une pioche quand cette dernière sera épuisée.</p>
      <img src="https://github.fr.world.socgen/societe-generale/GreenCircle/tree/main/src/main/resources/view/assets/Tuto_DeckBuilding.png" />
      ...
      <p>
        ...
        Chaque tâche baclée lors de la livraison d’une application rapporte une compétence <strong>Dette Technique</strong>. Ces compétences ne servent à rien, à part à ralentir l’équipe de développement quand elles s’accumulent.
        <img src="https://github.fr.world.socgen/societe-generale/GreenCircle/tree/main/src/main/resources/view/assets/Tuto_Application.png" />
      </p>
      ...
      <div class="statement-new-league-rule">
        ...
        <p>
          ...
          <br>Si elle n’en a pas assez, elle récupère une <strong>Dette Technique</strong> par <strong>compétence</strong> manquante.
        </p>
        <!-- END -->
        <!-- BEGIN level3 -->
      </div>
      ...
      <ul>
         ...
         <li>Priorisation des tâches <strong>TASK_PRIORITIZATION</strong> (3). L’équipe se débarrasse d’une carte <strong>compétence</strong> de sa main et récupère une carte <strong>compétence</strong> spécifique disponible.</li>
          </ul>
      <!-- END -->
      <!-- BEGIN level3 -->
        </div>
  ...
  <li>Intégration Continue <strong>CONTINUOUS_INTEGRATION</strong> (5). L’équipe automatise une de ses <strong>compétences</strong> disponibles dans sa main. <br>Cette carte ne sera pas défaussée à la fin du tour (elle sera toujours disponible) et ne pourra servir que pour livrer une application.</li>
      ...
      <div class="statement-new-league-rule">
        ...
        <ul>
          <li>Refactoring <strong>REFACTORING</strong>(7). L’équipe se débarrasse définitivement d’une <strong>Dette Technique</strong> de sa main.</li>
        </ul>
        <!-- END -->
        <!-- BEGIN level2 -->
      </div>
      ...
      <p>
        ...
        <br>N’oubliez pas, si vous baclez des tâches, vous recevrez de la <strong>Dette Technique</strong> !
      ...
      <p>
        Le hackathon s’arrête dés qu’une équipe a réussi à livrer 5 applications.
        ...
        Si les joueurs ont livré le même nombre d’applications, le gagnant est le joueur qui possède le moins de <strong>Dette Technique</strong>.
      </p>
      ...
      <div class="blk">
        ...
        <div class="text">
          <ul style="padding-top:0; padding-bottom: 0;">
            ...
            <li>En cas d'égalité, vous avez moins de <strong>Dette Technique</strong> que votre adversaire.
            </li>
          </ul>
        </div>
      </div>
     ...
     <div class="statement-new-league-rule">
      ...
      <div class="statement-expert-rules-content">
        <ul style="padding-left: 20px;padding-bottom: 0">
          ...
          <li>
            <p>
              En cas d'égalité, le joueur qui a le moins de <strong>Dette Technique</strong> gagnera.
            </p>
          </li>
          <li>
            <p>
  ...
  <div class="statement-section statement-protocol">
    ...
    <div class="blk">
      ...
      <div class="text">
        <span class="statement-lineno">Ligne 1&nbsp;:</span> le nom <var>gamePhase</var> de la phase actuelle avec l’action attendue. Peut être MOVE, <!-- BEGIN level2 level3 -->GIVE_CARD, <!-- END --><!-- BEGIN level3 -->THROW_CARD, <!-- END --><!-- BEGIN level2 level3 -->PLAY_CARD, <!-- END -->RELEASE
        <br>
        ...
        <var>location</var>: le poste de travail occupé.
        <var>score</var>: le nombre d’applications livrées.
        <var>permanentDailyRoutineCards</var>: <!-- BEGIN level1 level2 -->non utilisé dans cette ligue.<!-- END --><!-- BEGIN level3 level4 -->le nombre de cartes point d'équipe quotidien <strong>DAILY_ROUTINE</strong> (2) jouées.<!-- END -->
        <var>permanentArchitectureStudyCards</var>: <!-- BEGIN level1 -->non utilisé dans cette ligue.<!-- END --><!-- BEGIN level2 level3 level4 -->le nombre de cartes étude d'architecture <strong>ARCHITECTURE_STUDY</strong> (2) jouées.<!-- END -->
        <br>
        ...
        L'emplacement peut être HAND, DRAW, DISCARD<!-- BEGIN level1 level2 --> or OPPONENT_CARDS<!-- END --><!-- BEGIN level3 level4 -->, AUTOMATED, OPPONENT_CARDS or OPPONENT_AUTOMATED<!-- END -->
        <br>
        <span class="statement-lineno">Ligne suivante&nbsp;:</span>
